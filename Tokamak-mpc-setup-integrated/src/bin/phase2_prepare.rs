...
fn main() {
    ...
    let alpha1xyG1s = latest_acc.get_alphaxy_g1_range(1, 2048, li_y_vec[0].y_size);
    let alpha2xyG1s = latest_acc.get_alphaxy_g1_range(2, 2048, li_y_vec[0].y_size);
    let alpha3xyG1s = latest_acc.get_alphaxy_g1_range(3, 2048, li_y_vec[0].y_size);
    ...
    let mut multpxy_coeffs = vec![ScalarField::zero(); 2048 * li_y_vec[0].y_size];
