...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v3.8.0"
  WORKING_DIRECTORY "/mnt/d/MPC_ceremony/SNARK-MPC-setup/v2/phase2/target/debug/build/icicle-bls12-381-4daf6f4b3f919e7a/out/build/_deps/taskflow-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/d/MPC_ceremony/SNARK-MPC-setup/v2/phase2/target/debug/build/icicle-bls12-381-4daf6f4b3f919e7a/out/build/_deps/taskflow-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/d/MPC_ceremony/SNARK-MPC-setup/v2/phase2/target/debug/build/icicle-bls12-381-4daf6f4b3f919e7a/out/build/_deps/taskflow-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
