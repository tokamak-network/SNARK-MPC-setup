...
${tau\_powers\_g1} = \left\{ \tau^i \cdot G_1 \mid i \in \{0, 1, 2, \dots, 2^{n+1} - 2\} \right\}$
${tau\_powers\_g2} = \left\{ \tau^i \cdot G_2 \mid i \in \{0, 1, 2, \dots, 2^n - 1\} \right\}$
${alpha\_tau\_powers\_g1} = \left\{ \alpha \cdot \tau^i \cdot G_1 \mid i \in \{0, 1, 2, \dots, 2^n - 1\} \right\}$
${beta\_tau\_powers\_g1} = \left\{ \beta \cdot \tau^i \cdot G_1 \mid i \in \{0, 1, 2, \dots, 2^n - 1\} \right\}$
