...
//     CurveAffine, EncodedPoint, Engine, GroupDecodingError, Wnaf
// };
// use bellman_ce::pairing::bls12_381::{Bls12, Fr, G1, G2, G1Affine, G2Affine};
...
impl Bls12CeremonyParameters {
    pub const REQUIRED_POWER: usize = 13;
    pub const TAU_POWERS_G1_LENGTH: usize = 1 << Self::REQUIRED_POWER;
    pub const TAU_POWERS_LENGTH: usize = (1 << Self::REQUIRED_POWER) + 1;

    // BLS12-381 spesifik değerleri:
    pub const G1_UNCOMPRESSED_BYTE_SIZE: usize = 96;
    pub const G2_UNCOMPRESSED_BYTE_SIZE: usize = 192;
    pub const CONTRIBUTION_BYTE_SIZE: usize = 64; // Güncellenmeli
    pub const PUBLIC_KEY_SIZE: usize = 96; // Güncellenmeli
    pub const ACCUMULATOR_BYTE_SIZE: usize = 512; // Güncellenmeli
}
...
const TAU_POWERS_LENGTH: usize = 1 << 13;
