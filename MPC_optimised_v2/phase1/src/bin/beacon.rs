...
fn main() {
    ...
    let mut rng = {
        ...
        // Place block hash here (block number #876960)
        let mut cur_hash: [u8; 32] = hex!("0000000000000000000139773a9f91a256b5472f619b4bd297d07836a6587ffe");
...

    {
        ...
        let expected_challenge_length = match INPUT_IS_COMPRESSED {
            ...
            UseCompression::No => Bls12CeremonyParameters::ACCUMULATOR_BYTE_SIZE,  // ✅ Düzeltildi!
        };
